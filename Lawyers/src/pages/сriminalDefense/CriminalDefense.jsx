                        ...
                        <div className={styles.protectionCriminalProceedingsBox}>
                            <div className={styles.protectionCriminalProceedingsText}>
                                <p style={{ fontWeight: '500' }}>
                                    Защита в уголовном процессе РОССИЯ - возможна для разных категорий лиц, и прежде, чем выбирать способ способ
                                    необходимо ознакомиться с материалами дела, это право предусмотрено согласно УПК. Существует четыре стадии:
                                </p>
                    ...
                    <section className={styles.recommendationsContainer}>
                        <p>
                            <span>
                                ...
                                Помните - без доказательства умысла, причастности - вины, Вас никто не посадит. Если же это случилось
                                необходимо обжаловать приговор в суд вышестоящей инстанции.
                            </span>

                            <span>
                                Если Вы или Ваш знакомый или родственник находится под следствием - срочно нанимайте опытного адвоката либо можете
                                надеяться на помощь государственного бесплатного адвоката.
                            </span>
                        </p>
                    </section>
